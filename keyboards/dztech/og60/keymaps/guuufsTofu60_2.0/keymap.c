...
// qmk compile -kb dztech/og60 -km guuufsTofu60_2.0
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_60_iso(
    ...
    OSM(MOD_LSFT), KC_INT1, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(1),
    KC_LCTL,       KC_LALT, KC_LGUI,                                     KC_SPC,                    KC_RGUI, KC_RALT, KC_RCTL
  ),
  [1] = LAYOUT_60_iso(
    QK_BOOT, KC_F1  , KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, KC_DEL,
